    ...
    <div class="auth-card w-full max-w-md p-8 my-8 rounded-container-token"
        ...
        {#if mounted}
            ...
            <form method="POST" class="space-y-6" use:focusTrap={true}
                ...
                <label class="label" in:fly="{{ y: 20, duration: 400, delay: 600 }}">
                    <span>Email</span>
                    <input
                        type="email"
                        name="email"
                ...
                <div class="flex items-center justify-between mt-2"
                    ...
                    <a
                        ...
                        class="anchor text-sm hover:underline hover:text-primary-400"
                    >
                        Forgot Password?
                    </a>
                </div>
                ...
                <hr class="neon-border my-8" in:fade="{{ duration: 400, delay: 1000 }}" />
                ...
                <div class="grid grid-cols-2 gap-4" in:fly="{{ y: 20, duration: 400, delay: 1100 }}">
                    <button
                        type="button"
                ...
                <div class="text-center" in:fly="{{ y: 20, duration: 400, delay: 1200 }}">
                    <p class="text-surface-600-300-token mb-4 divider-text">Don't have an account?</p>
                    <a 
                        href="/auth/register"
